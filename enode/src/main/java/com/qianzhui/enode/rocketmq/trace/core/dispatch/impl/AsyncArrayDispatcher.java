...
public class AsyncArrayDispatcher extends AsyncDispatcher {
    ...
    @Override
    public void start(final AsyncAppender appender, final String workName) {
    ...
    class AsyncAppenderRequest implements Runnable{
         ...
         *            本批次的轨迹数据
         */
        private void sendTraceDataByMQ(Set<String> keySet, String data,String currentRegionId) {
            ...
            try {
                traceProducer.send(message, new SendCallback() {
                    ...
                    public void onException(Throwable e) {
                        ...
                        clientlog.info("send trace data ,the msgidSet is"+message.getKeys());
                    }
                }, 5000);
            }
            catch (Exception e) {
